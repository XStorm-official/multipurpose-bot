...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if (img == null) img = "https://i.ibb.co/CMgXzWC/standard.gif"
        ...
        if (args[0] === "settings") {
            ...
            if (owner.get(`owners.${message.author.id}`) || config.app.owners.includes(message.author.id) === true) {
        ...
        if (args[0] === "all") {
            ...
            const imgperm = "https://i.ibb.co/CMgXzWC/standard.gif"
            ...
            const help = new Discord.MessageEmbed()
                ...
                .setDescription(`${emote.utilitaire.coin}・Ce bot appartient au serveur ${config.app.serveur}`)
                .setImage(imgperm)
                .setColor(color)
...
**\`${pf}support\`**
Si vous cherchez des bots personnalisé en tout genre notre rejoingnez notre support, si vous cherchez un devéloppeur pour des bots sur demande mp le développeur <@1096572738606469171>
