...
module.exports = {
    ...
    async execute(client, message, args) {
        ...
        //hétéros
        if (member == '1096572738606469171') return message.channel.send({ embeds: [notgay] }) //Funny
        if (member == '907161332883804170') return message.channel.send({ embeds: [notgay] }) //Mizuke
        //Les pd
        if (member == '465991413998551072') return message.channel.send({ embeds: [biengay] }) //Beta
